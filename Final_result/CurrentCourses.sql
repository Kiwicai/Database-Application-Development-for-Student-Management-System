delimiter //
drop procedure if exists currentCourses //
create procedure currentCourses
...
begin	
    ...
    where 	S.Id = T.StudId and T.Grade is null and
			T.Semester = QuarterNow and T.Year = year(now());
		
end; //
delimiter ;

-- call currentcourses(3213, "lunch");